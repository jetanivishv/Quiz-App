...
const fetchurldata = () => {
    ...
    if(x=="javascript" || x=="laravel" || x=="devops"){
        y="easy";
    }
    if(z>20){
        z=20;
...
fetch(
    // `https://opentdb.com/api.php?amount=10&category=23&difficulty=easy&type=multiple&&tags=html`
...
nextquestion = () => {
    ...
    if (availableQuestions.length === 0 || questionCounter > MAX_QUESTIONS) {
        ...
        return window.location.replace('quizend.php');
    }
    if (a != 0){
